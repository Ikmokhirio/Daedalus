...
namespace Daedalus {
    extern void
    DisplayImage(const ImageDescriptor &desc, const ImVec2 &size = ImVec2(0, 0), const ImVec2 &uv0 = ImVec2(0, 0),
                 const ImVec2 &uv1 = ImVec2(1, 1), const ImVec4 &tint_col = ImVec4(1, 1, 1, 1),
                 const ImVec4 &border_col = ImVec4(0, 0, 0, 0));

    extern bool DisplayImageButton(const ImageDescriptor &desc, const ImVec2 &size = ImVec2(0, 0),
